...
public class Car {
	...
	- 속도	- 시동	- 기어	- 전방등	 - 후방등       - 와이퍼 속도
	
	2. 생성자를 생성 => 멤버 변수 초기화
	속도 = 0, 시동 = off, 기어 = 파킹, 전방등or후방등 = off
	와이퍼속도 = 0
	...
	*/
	...
	public void setForntLight(boolean forntLight) {
		this.forntLight = forntLight;
	}
	...
	if(forntLight){ System.out.println("전방등이 켜져 있습니다 ");
	}else {System.out.println("전방등이 꺼져 있습니다 ");
		}
	
	if(backLight){ System.out.println("전방등이 켜져 있습니다 ");
	}else {System.out.println("전방등이 꺼져 있습니다 ");
		}
	
	switch(wiperSpeed){
	 case '0' : System.out.println("와이퍼 : 정지");
	 case '1' : System.out.println("와이퍼 : 정지");
	 case '2' : System.out.println("와이퍼 : 보통");
	 case '3' : System.out.println("와이퍼 : 빠름");
		}
	}}